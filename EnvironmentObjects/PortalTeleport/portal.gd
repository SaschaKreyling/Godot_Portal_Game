...
@onready var player_camera: Camera3D = %Player/PlayerMainCamera
...
@onready var portal_camera_viewport: Viewport = $PortalViewport
...
func set_activated() -> void:
	...
	portal_camera_viewport.render_target_update_mode = portal_camera_viewport.UPDATE_ALWAYS
...
func set_deactivated() -> void:
	...
	portal_camera_viewport.render_target_update_mode = portal_camera_viewport.UPDATE_DISABLED
...
func _on_viewport_resize() -> void:
	portal_camera_viewport.size = player_camera.get_viewport().size * SettingsManager.get_portal_quality_scale()
