...
const BUTTON_DEACTIVATED_MESH : Mesh = preload("res://assets/meshes/button.obj")
const BUTTON_ACTIVATED_MESH : Mesh = preload("res://assets/meshes/button_activated.obj")
const BUTTON_GLUED_ACTIVATED_MESH : Mesh = preload("res://assets/meshes/button_glued.obj")
const BUTTON_GLUED_DEACTIVATED_MESH : Mesh = preload("res://assets/meshes/button_glued_deactivated.obj")
